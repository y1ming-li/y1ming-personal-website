...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col items-center gap-1 bg-accent pt-[calc(2/5*100vh_-_200px)]">
      ...
      />
      <nav className="flex flex-col items-center gap-2 animate-fade-up [animation-delay:0.2s]">
      ...
      <div className="mt-auto pb-10 flex gap-6 animate-fade-up [animation-delay:0.4s]">
